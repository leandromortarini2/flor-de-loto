...
export const About: React.FC = () => {
  return (
    <div
      id="about"
      className="w-full min-h-screen bg-white lg:bg-bgAbout pt-20 flex flex-col lg:flex-row justify-center items-center bg-cover"
    >
      ...
      <div className="w-full lg:w-1/2 lg:h-full flex justify-center  lg:justify-start items-center px-4 ">
        <div className="w-full lg:w-2/3 flex flex-col justify-center items-center gap-4">
          ...
          <p className="font-textSecondary text-start px-5 md:px-16 lg:px-0 text-base md:text-xl lg:text-2xl font-light">
